    ...
    if (!_roomsBox!.containsKey(roomUpdate.id.toHiveKey)) {
      await _roomsBox!.put(
          ...
          Room(
            ...
            highlightCount: roomUpdate.highlight_count as int?,
            notificationCount: roomUpdate.notification_count as int?,
      ...
      await _roomsBox!.put(
          ...
          Room(
            ...
            highlightCount:
                roomUpdate.highlight_count as int? ?? currentRoom.highlightCount,
            notificationCount:
                roomUpdate.notification_count as int? ?? currentRoom.notificationCount,
...
extension HiveKeyExtension on String? {
  String get toHiveKey => this!.isValidMatrixId
      ? '${this!.sigil}${Uri.encodeComponent(this!.localpart!)}:${Uri.encodeComponent(this!.domain!)}'
